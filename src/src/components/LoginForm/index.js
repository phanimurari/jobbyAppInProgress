    ...
    return (
      <LoginPage>
        <LoginFormContainer onSubmit={this.onFormSubmit}>
          ...
          <LoginFormLabel>{strings.userNameLabelText}</LoginFormLabel>
          <LoginFormInputField
            placeholder={strings.userNamePlaceholderText}
            onChange={this.onChangeUserName}
            value={userName}
          />
          <LoginFormLabel>{strings.userPasswordLabelText}</LoginFormLabel>
          <LoginFormInputField
            type="password"
            placeholder={strings.userPasswordPlaceholderText}
